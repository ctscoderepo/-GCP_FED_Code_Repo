...
const ProductDetailComponent = props => {
  ...
  console.log("shipToStoreData From pdp", shipToStoreData);
  ...
  const productShipToStore = e => {
    e.preventDefault();
    let storeAndProduct = {
      product: product,
      storeName: storeName
    };
    productDetailsToConfirm(storeAndProduct);
          ...
          <Grid lg={5} sm={5} xs={12} item>
            ...
            <div className={classes.priceDiv}>
              ...
              <div style={{ textAlign: "right", marginTop: "-40px" }}>
                ...
                <Typography style={{ marginTop: "-38px" }}>
                  {" "}
                  4.0 of 5
                </Typography>
              </div>
            ...
            <div className={classes.stockQnty}>
              <strong>
                Stock Quantity : <span>{product.stockQuantity}</span>
              </strong>
            </div>
            <Divider className={classes.dividerStyle} />
            <div className={classes.stockQnty}>
            ...
            <Grid container spacing={8} style={{ marginBottom: "50px" }}>
              <Grid item lg={4} sm={4} xs={12}>
                <div style={{ marginTop: "10px" }}>
                  ...
                  <button className={classes.qtyBtnPlus} onClick={addQuantity}>
                    +
                  </button>
                </div>
              </Grid>
